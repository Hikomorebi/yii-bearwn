...
<head>
	...
	<title>bear - Admin Dashboard</title>
								...
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												<h4>Hizrian</h4>
												<p class="text-muted">hello@example.com</p><a href="/backend/web/index.php?r=user%2Findex" class="btn btn-xs btn-secondary btn-sm">Users</a>
											</div>
										</div>
									</li>
									<li>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="bulletinboard">
								<ul class="nav nav-collapse">
									<li>
										<form action="/backend/web/index.php?r=site%2Fshow" method="post">
											<input type="hidden" name="_csrf-backend" value="<?= Yii::$app->request->csrfToken ?>">
											<button type="submit" class="btn btn-link logout">公告板 </button>
										</form>
										<form action="/backend/web/index.php?r=site%2Fnewb" method="post">
											<input type="hidden" name="_csrf-backend" value="<?= Yii::$app->request->csrfToken ?>">
