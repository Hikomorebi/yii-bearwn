...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title>bear - Information Dashboard</title>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown menu-merge">
          <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
          	<img src="statics/assets/img/avatars/6.jpg" alt="avatar" class="mw30 br64">
    ...
    <aside id="sidebar_left" class="nano nano-light affix">
      ...
      <div class="sidebar-left-content nano-content">
          ...
          <div class="sidebar-widget author-widget">
            <div class="media">
              <a class="media-left" href="#">
                <img src="statics/assets/img/avatars/6.jpg" class="img-responsive">
              </a>
        ...
        <!-- End: Sidebar Header -->
         ...
         <li>
             <li>
               <a href="index.php?r=site/news">
                 <span class="glyphicon glyphicon-fire"></span> 奥运新闻</a>
             </li>
         </li>
       <li>
             <li>
           ...
           <a class="accordion-toggle" href="">
             ...
             <li>
               <a href="<?php echo Url::to(['site/selfwork']) ?>">
                 <span class="glyphicon glyphicon-saved"></span> 何坤彬</a>
             </li>
             <li>
               <a href="<?php echo Url::to(['site/selfwork2']) ?>">
                 <span class="glyphicon glyphicon-saved"></span> 刘成</a>
             </li>
             <li>
               <a href="<?php echo Url::to(['site/selfwork3']) ?>">
                 <span class="glyphicon glyphicon-saved"></span> 李元</a>
             </li>
             <li>
               <a href="<?php echo Url::to(['site/selfwork4']) ?>">
                 <span class="glyphicon glyphicon-saved"></span> 冀放</a>
             </li>
         </li>


         <li class="sidebar-label pt15">奥运信息</li>
         <li>
           </a>
             <li>
               <a href="<?php echo Url::to(['gold/index']) ?>">
                 <span class="glyphicon glyphicon-fire"></span> 奖牌榜</a>
             </li>
             <li>
               <a href="<?php echo Url::to(['sportsman/index']) ?>">
                 <span class="glyphicon glyphicon-fire"></span> 运动员信息</a>
             </li>
         </li>
